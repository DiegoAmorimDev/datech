  ...
  return (
    <section id="contato" className="py-24 md:py-32">
      <div className="container mx-auto px-6">
        ...
        >
          <p className="text-sm uppercase tracking-[0.3em] text-primary mb-3">Vamos conversar</p>
          <h2 className="font-display text-4xl md:text-5xl font-bold text-foreground">Entre em Contato</h2>
        </motion.div>
