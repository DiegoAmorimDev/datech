...
const testimonials = [
  {
    ...
    role: "CEO, ModaStyle",
    text: "A DATECH transformou completamente nossa presença online. O e-commerce ficou incrível e nossas vendas triplicaram em 3 meses!",
  },
  {
    name: "Roberto Mendes",
    role: "Diretor, TechSolutions",
    text: "O sistema de gestão desenvolvido pela equipe do Diego superou todas as expectativas. Eficiente, intuitivo e extremamente bem feito.",
  },
  {
    name: "Fernanda Oliveira",
    role: "Fundadora, GreenMarket",
